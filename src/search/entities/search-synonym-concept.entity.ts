...
@Index('idx_synonym_concepts_concept_key_en', ['concept_key_en'], { unique: true })
export class SearchSynonymConcept {
  @PrimaryGeneratedColumn('uuid')
  id: string;

  /**
   * Unique English key used as the Typesense synonym ID.
  ...
  /**
   * Arabic label for this concept. e.g. "شاحن متنقل"
   * Generated by AI alongside concept_key_en.
   */
   ...
   * Equals concept_key_en when approved, null otherwise.
   */
  @Column({ nullable: true, type: 'varchar' })
